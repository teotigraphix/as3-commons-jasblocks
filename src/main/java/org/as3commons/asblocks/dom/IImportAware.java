...
public interface IImportAware
{
	 ...
	 */
	public IASImportStatement newImport(IASExpression name);
	 ...
	 * @return A <code>IASImportStatement</code>.
	 */
	public IASImportStatement parseImport(String name);
	 ...
	 */
	public IASImportStatement removeImport(String name);
